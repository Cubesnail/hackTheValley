...
"""
# Bugfix by Jakub Gedeon: allow sending literal "}" as "{}}"
#                         changed structs to work multiplatform
import time
import ctypes
...
class KeyAction(object):
    """Class that represents a single 'kpad.exe
    Hello Weyboard' action
